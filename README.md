...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,bash,vim,vscode,docker,wordpress,nginx,stackoverflow,github,git,visualstudio,arduino)](https://skillicons.dev)
